			...
			<section class="content_wrap">
				...
				<!-- 보낼내용들 -->
						...
						<!-- 기안자박스  -->
									...
									<tbody>
										<tr>
											<td class="style-title" colspan="2">지각(결근/불참)사유서</td>
										</tr>
										<tr>
											<td class="top-left">
											<table>
								...
								<table class="content-table">
									...
									<tbody>
										<tr>
											...
											<td class="con-cate">예정시간</td>
											<td class="con-dep"><input type="text" class="ipt-editor" value="출근시간 9:00"></td>
										</tr>		
										<tr>
											<td class="con-cate">지각시간</td>
											<td class="con-dep" colspan="3"><input type="text" class="ipt-editor" value="출근시간 이후 0 시간 30분 지각" readonly></td>
										</tr>		
										<tr>
											<td class="con-cate">제목</td>
											<td class="con-title" colspan="3"><input type="text" class="ipt-editor" value="지각사유서 제출립니다"></td>
										</tr>		
										<tr>
											<td colspan="4" class="editor-text">
												<div id="editor">상기본인은 금일 위와 같은 사유로 출근시간을 엄수하지 못하였고 
												향 후 에는 출근시간을 엄수 할 것을 약속하며 이에 사유서를 제출합니다.</div>
											</td>
										</tr>		
									</tbody>
								</table>
