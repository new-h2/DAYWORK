...
<!-- 						<p class="style-title">업무 기안서</p> -->
				<!-- 보낼내용들 -->
						...
						<!-- 기안자박스  -->
									...
									<tbody>
										<tr>
											<td class="style-title" colspan="2">업무협조</td>
										</tr>
										<tr>
											<td class="top-left">
											<table>
						...
						<!-- 내용박스 -->
								<table class="content-table">
									...
									<tbody>
										<tr>
											<td class="con-cate">요청일</td>
											<td class="con-date"><input type="text" class="ipt-editor" value="2021-08-15"></td>
											<td class="con-cate">수신부서</td>
											<td class="con-dep"><input type="text" class="ipt-editor" value="인사팀"></td>
										</tr>		
										<tr>
											<td class="con-cate">합의</td>
											<td class="con-dep" colspan="3"><input type="text" class="ipt-editor" value=" " readonly></td>
										</tr>		
										<tr>
											<td class="con-cate">제목</td>
											<td class="con-title" colspan="3"><input type="text" class="ipt-editor" value="채용요청부탁드립니다"></td>
										</tr>		
										<tr>
